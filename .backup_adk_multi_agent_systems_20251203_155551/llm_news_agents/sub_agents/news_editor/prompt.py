...
"""Prompt for the news editor agent."""
...
Output format:
  ...
  * If the answer is inaccurate, disputed, or unsupported, the `search_fact_check` tool to retrieve any matching fact‐checks, Then you should output your revised answer text,
