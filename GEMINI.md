...
from llm_news_agents.agent import root_agent
from google.genai import types as genai_types
...
async def main():
    ...
    await session_service.create_session(
        app_name="llm_news_agents", user_id="test_user", session_id="test_session"
    )
    runner = Runner(
        agent=root_agent, app_name="llm_news_agents", session_service=session_service
    )
