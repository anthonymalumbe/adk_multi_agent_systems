...
@click.option(
    "--display-name",
    default="adk-multi-agent-systems",
...
@click.option(
    "--requirements-file",
    default="llm_news_agents/app_utils/.requirements.txt",
    help="Path to requirements.txt file",
)
@click.option(
    "--env-file",
    default=None,
    help="Path to .env file for environment variables (defaults to llm_news_agents/.env)",
)
@click.option(
    "--set-env-vars",
    default=None,
